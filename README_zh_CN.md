...
> 为了可以自包含，我把所有 xalanq 都无耻的替换了成 cuzperf，抱歉，侵删
...
你可以从[这里](https://github.com/cuzperf/cf-tool/releases)直接下载一个可执行文件。
...
例子:
  ...
  cf clone cuzperf     拉取 cuzperf 的所有提交代码。
...
模板内的脚本:
  ...
  $%path%$   代码的路径 (不包括 $%full%$， 比如 "/home/cuzperf/")
