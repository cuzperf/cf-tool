...
[![Github release](https://img.shields.io/github/release/cuzperf/cf-tool.svg)](https://github.com/cuzperf/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/cuzperf/cf-tool/releases)
[![Build Status](https://travis-ci.org/cuzperf/cf-tool.svg?branch=master)](https://travis-ci.org/cuzperf/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/cuzperf/cf-tool)](https://goreportcard.com/report/github.com/cuzperf/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/cuzperf/cf-tool/master/LICENSE)
...
> I replace all xalanq to cuzperf since I want to self contains. Sorry for that!!!
...
You can download the pre-compiled binary file in [here](https://github.com/cuzperf/cf-tool/releases).
...
go get github.com/cuzperf/cf-tool
cd ~/go/src/github.com/cuzperf/cf-tool
go env -w CGO_ENABLED="0"
go build -ldflags "-s -w" cf.go
```

add `~/go/src/github.com/cuzperf/cf-tool` in your path, and replace cf-tool by this repo, then

> You may need `sudo add-apt-repository ppa:longsleep/golang-backports -y` to install lastest version of golang for Ubuntu

## Refine

- fix `Cannot find csrf`
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone cuzperf      Clone all codes of cuzperf.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/cuzperf/")
 ...
 * You can download the binary file in here https://github.com/cuzperf/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
